...
(function (factory) {
    ...
    DataTable.feature.register(
        ...
        function (settings, opts) {
            ...
            filter.find("input").addClass("input-responsive");
            ...
            filter.find("input").focus(function () {
                $(this).css({
                    ...
                    boxShadow: "none",
                    background: " linear-gradient(to bottom, transparent, #E4EBF0)",
                });
            });
            ...
            var searchButton = $("<button>")
                .attr("type", "button")
                .addClass("btn btn-buscar btn-search-datatable")
                .html(
                    '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16"><path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001l3.85 3.85a1 1 0 0 0 1.415-1.415l-3.85-3.85zm-5.442 1.398a5.5 5.5 0 1 1 0-11 5.5 5.5 0 0 1 0 11z"/></svg>'
                )
                .on("click", function () {
                    let val = filter.find("input").val();
    ...
    $(document).ready(function () {
        // Inicializa todas las tablas con clase .datatable
        $(".example").each(function () {
            $(this).DataTable();
        });

        // Delegación para botones dentro de cualquier tabla .example
        $(".example").on("click", ".btn-dt-tabla", function () {
            const id = $(this).data("id-tabla");

            // Si usas UIkit
            if (typeof UIkit !== "undefined" && UIkit.modal("#" + id)) {
                UIkit.modal("#" + id).show();
            }
